...
try:
    ...
    from autosearch.stage9_ppt.builtin_imagegen_handoff import prepare_handoff
...
def run_stage9(topic_dir: Path, *, mock: bool = True, force: bool = False, style_profile: str = "academic_light") -> dict[str, Any]:
