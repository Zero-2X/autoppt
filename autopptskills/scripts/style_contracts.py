...
STYLE_PROFILES: dict[str, dict[str, Any]] = {
    "academic_light": {
        ...
        "design_density": "evidence-rich-readable",
        "style_contract": (
            "polished academic information design: white or very light paper background, "
            "low-saturation navy/teal palette, restrained red emphasis, balanced margins, "
        ...
        "palette": "background #F7F9FC/#FFFFFF; ink #172033; navy #173F5F; teal #2A7F8E; accent #B4232D; gray #64748B",
    ...
    "academic_minimal": {
        ...
        "palette": "background #FFFFFF/#F8FAFC; ink #172033; navy #24445F; accent #B4232D; gray #6B7280",
    ...
    "deep_academic": {
        ...
        "style_contract": "immersive but disciplined dark academic information design: deep navy field, muted blue/teal structure, restrained red emphasis, source-grounded imagery, strong grid, conclusion-led titles, and evidence-first hierarchy",
        "palette": "background #101827/#172235; ink #F3F6FA; navy #2B5C88; teal #58A6A6; accent #B4232D; muted #A9B7C8",
    ...
    "editorial_warm": {
        ...
        "palette": "background #FBF7F0/#FFFDFC; ink #2A2927; rust #B65F43; olive #66745A; accent #B4232D; gray #7A746C",
    ...
    "engineering_blueprint": {
        ...
        "palette": "background #F5F8FB/#FFFFFF; ink #152A3A; navy #1F4E6D; cyan #2D8FA3; accent #B4232D; steel #6B7F8D",
    ...
    "clinical_clean": {
        ...
        "style_contract": "polished clinical-scientific presentation design: clean white field, cool blue-green structure, restrained red emphasis, precise mechanism, cohort, chart, and study-flow graphics, conclusion-led titles, and high-legibility evidence hierarchy",
        "palette": "background #FFFFFF/#F6FAFA; ink #16313A; blue #2D6F8A; green #4D8B78; accent #B4232D; gray #6D7F84",
    ...
    "graduate_defense_navy": {
        ...
        "style_contract": "newly authored graduate-defense information design: quiet white or pale slate field, generic deep navy structure, restrained red emphasis, formal section rhythm, conclusion-led titles, and a clear claim-evidence-defense hierarchy",
        "palette": "background #F7F8FA/#FFFFFF; ink #17212B; navy #17324D; blue #365C7D; accent #B4232D; gray #66727E",
    ...
    "institutional_purple_light": {
        ...
        "intentional_minimal": False,
        "design_density": "institutional-medium-rich",
        "style_contract": "newly authored light institutional presentation design: warm white field, non-canonical muted aubergine structure, soft plum secondary color, restrained red emphasis, disciplined title bands, and evidence-led asymmetry without source-institution branding",
        "palette": "background #FAF8FB/#FFFFFF; ink #281F2D; aubergine #5D3B67; plum #765078; accent #B4232D; gray #716A75",
    ...
    "engineering_institutional_blue": {
        ...
        "style_contract": "newly authored engineering institutional presentation design: white or pale blue-gray field, generic medium navy structure, muted cyan evidence accents, restrained red emphasis, formal report rhythm, and specific systems, mechanisms, and measured results",
        "palette": "background #F5F8FA/#FFFFFF; ink #172833; navy #23506B; blue #3D718D; cyan #4B96A6; accent #B4232D; gray #687C87",
    ...
    "science_dark_contrast": {
        ...
        "style_contract": "newly authored high-contrast scientific presentation design: deep charcoal-navy field, off-white type, muted blue-green evidence structure, restrained red emphasis, direct annotation, and one-message-per-slide scientific reasoning",
        "palette": "background #111820/#18232D; ink #F4F6F7; blue #4F7E9B; teal #58A09A; accent #B4232D; muted #A9B5BE",
    ...
    "nsfc_review_light": {
        ...
        "style_contract": "newly authored review-oriented academic presentation design: clean white field, neutral dark ink, generic navy structure, restrained red emphasis, traceable claim-evidence-method-feasibility logic, and conservative high-legibility composition",
        "palette": "background #FFFFFF/#F7F8FA; ink #202A33; navy #294F68; blue #4A7188; accent #B4232D; gold #AA8A54; gray #6F7B83",
